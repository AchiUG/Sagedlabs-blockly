...
/**
 * Helper to define blocks safely only if they haven't been defined yet.
 * This prevents "re-definition" errors in environments with HMR or multiple Blockly instances.
 */
function safeDefine(Blockly: any, type: string, defineFn: () => void) {
...
export function defineCustomBlocks(Blockly: any) {
  ...
  safeDefine(Blockly, 'saged_on_start', () => {
  ...
  safeDefine(Blockly, 'saged_on_key', () => {
  ...
  safeDefine(Blockly, 'saged_move_x', () => {
    Blockly.defineBlocksWithJsonArray([
      {
        type: 'saged_move_x',
  ...
  safeDefine(Blockly, 'saged_x_position', () => {
    Blockly.defineBlocksWithJsonArray([
      {
  ...
  safeDefine(Blockly, 'saged_key_pressed', () => {
  ...
  safeDefine(Blockly, 'saged_create_object', () => {
    Blockly.defineBlocksWithJsonArray([
      {
